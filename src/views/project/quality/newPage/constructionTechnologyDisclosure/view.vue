	...
	methods: {
		...
		getProjectInfoById() {
			projectApi.getProjectDetail({
				...
				let data = res || {};
				const { projectName, starttime, constructdpt, supervisordpt } = data
				this.baseInfo = { projectName, starttime, constructdpt, supervisordpt }
			});
		},
		getDetail(id) {
