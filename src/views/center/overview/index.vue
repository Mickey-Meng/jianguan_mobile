<template>
  <div class="wrapper" :style="{ height: scrollerHeight }">
    <div class="header common-card">235国道杭州至诸暨公路萧山河上至诸暨安华段改建工程</div>
    <div class="content">
        ...
        <div class="content-right-bottom common-card">
          ...
          <div class="card-content">
            <div>
              ...
              <ul>
                <li><span>建设单位:</span><span>诸暨市交通基础设施建设有限公司</span></li>
                <li>
                  <span>代建+监理单位:</span
                  ><span>浙江公路水运工程咨询有限责任公司、浙江交科公路水运工程监理有限公司</span>
                </li>
                <li>
                  <span>中标联合体单位：</span
                  ><span
                    >中交上海航道局有限公司、 中国交通建设股份有限公司、 浙江诸安建设集团有限公司、
